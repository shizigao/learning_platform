...
public class ContentInteractionService {
    ...
    public ContentReactionResponse state(Long contentId, Long userId) {
    ...
    @Transactional
    public ContentReactionResponse unlike(Long contentId, Long userId) {
        LearningContent content = getPublished(contentId);
    ...
    @Transactional
    public ContentReactionResponse favorite(Long contentId, Long userId) {
        LearningContent content = getPublished(contentId);
    ...
    @Transactional
    public ContentReactionResponse unfavorite(Long contentId, Long userId) {
        LearningContent content = getPublished(contentId);
    ...
    public PageResult<ContentCommentResponse> comments(Long contentId, PageQuery query) {
