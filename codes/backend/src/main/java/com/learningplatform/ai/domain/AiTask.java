/* 文件职责：表示AI任务领域对象或组件，封装该概念相关的数据和行为。
...
public class AiTask extends BaseEntity {
    ...
    /** 保存输入Chars，供该类型的业务逻辑读取或更新。 */
    private Integer inputChars;
    /** 保存额度Cost，供该类型的业务逻辑读取或更新。 */
